...
export default class Enregistrer extends Component
{
    ...
    {
      super(props);
      this.state={Nom:'',Maison:'',Adresse:'',Mdps:''};
    }
    InsertRecord=()=>
    {
      ...
      if(Nom.length==0 || Maison.length==0 || Adresse.length==0 || Mdps.length==0)
      {
        Alert.alert("خطأ في الببانات . يرجى التحقق.");
      }
      else
      {
        var InsertAPIURL="https://localhost/RNDB/RN.php";
        var headers=
        {
...
render(){
      ...
      >
        ...
        <MaterialIcons name="done-all" size={28} color="black" style={{ top:14,right:40,}} />
      ...
      <View style={{right:90,}}>
        ...
        <FontAwesome name="facebook-square" size={24} color="blue" style={{left:10,bottom:157}} />
        ...
        <TouchableOpacity
          ...
          <Text  style={{left:20,top:-0.5,fontSize:18}}>Google</Text>
          
        </TouchableOpacity>
     
        <FontAwesome name="google" size={24} color="black" style={{left:10,bottom:-54}} />
